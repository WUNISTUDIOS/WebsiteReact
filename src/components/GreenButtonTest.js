...
const MetalButtonLogo = ({ width = 264, height = 100, className = "" }) => {
  return (
    <svg
    ...
    >
        ...
        <g filter="url(#d)">
          ...
          <g clipPath="url(#f)" filter="url(#g)">
            <path
              fill="url(#h)"
              fillRule="evenodd"
              d="M161.591 133.206a2.788 2.788 0 0 1 2.542-1.643h31.592a2.786 2.786 0 0 1 2.42 4.17l-12.483 21.846h13.78a2.787 2.787 0 0 1 1.971 4.759l-40.884 40.883a2.787 2.787 0 0 1-4.675-2.647l6.568-26.27h-15.014a2.787 2.787 0 0 1-2.542-3.931l16.725-37.167Z"
              clipRule="evenodd"
            />
          </g>
          <g filter="url(#i)">
      ...
      <defs>
        ...
        >
          <stop stopColor="#128954" />
          <stop offset="1" stopColor="#1FAA6A" />
        </linearGradient>
        <linearGradient
          id="c"
          x1="527.875"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#79DCA8" />
          <stop offset=".5" stopColor="#0E5738" />
          <stop offset="1" stopColor="#79DCA8" />
        </linearGradient>
        <linearGradient
          id="e"
          x1="527.875"
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#44C585" />
          <stop offset="1" stopColor="#128954" />
        </linearGradient>
        <linearGradient
          id="h"
          x1="173.425"
        ...
        >
          ...
          <stop offset="1" stopColor="#CFF0E1" />
        </linearGradient>
        <linearGradient
          id="j"
          x1="583.625"
        ...
        >
          ...
          <feColorMatrix values="0 0 0 0 0.121569 0 0 0 0 0.666667 0 0 0 0 0.415686 0 0 0 0.16 0" />
          <feBlend
        ...
        <clipPath id="f">
          <path fill="#fff" d="M128.825 123.2h89.2v89.2h-89.2z" />
        </clipPath>
      </defs>
    </svg>
  )
...
export default MetalButtonLogo;
