    ...
    return (
        <section className='my-40'>
            <div className='flex flex-col content-center justify-evenly space-y-2'>
                <h1 className='font-bold text-center text-4xl xl:text-xl md:text-xl '
                >
                    Lolos.site
                </h1>
            ...
            <div className='p-5 flex flex-wrap items-start gap-2'>
            ...
            <p className='font-monument relative'>
                ...
                <video 
                    className="w-[30%] shadow-sm rounded-xl"
                    loop
                    autoPlay
                    muted
                >
                ...
                <Image
                    ...
                    width={3224}
                    height={4032}
                    className="w-[30%] h-full shadow-sm rounded-xl"
                />
            </div>
